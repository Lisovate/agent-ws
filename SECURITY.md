...
If you discover a security vulnerability in agent-ws, please report it through [GitHub Security Advisories](https://github.com/pblittle/agent-ws/security/advisories/new).
